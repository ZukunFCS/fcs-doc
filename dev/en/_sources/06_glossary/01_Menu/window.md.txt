...
:name: tab-window-profiles-gallery
...
:name: tab-window-profiles-editor
...
　・Freezing threshold：  
　　まばたきかどうかを判定する境目の設定です。  
　　オートトラッキングによる検出結果について、  
　　その動画内で最も目を開いている瞬間を1.0、完全に目が閉じている状態を0.0としたとき、  
　　0.0～1.0の範囲でどの地点からまばたきと判定するかを設定します。  
　　※デフォルト：0.5  
　　トラッキング結果が入力値より小さい場合、まばたきと判定して目線を固定します。  
